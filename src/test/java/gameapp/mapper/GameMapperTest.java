...
class GameMapperTest {
    ...
    @Test
    @DisplayName("Map CreateGame with empty strings")
    ...
    @Test
    @DisplayName("Map CreateGame with maximum length description")
    ...
    @Test
    @DisplayName("Map CreateGame with invalid UPC format")
